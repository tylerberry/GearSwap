...
function handle_elemental(cmdParams)
	...
	elseif command == 'skillchain4' then
      ...
      local saved_mode = state.CastingMode.value
      ...
      windower.send_command:schedule(21.1,'gs c set CastingMode ' .. saved_mode)
		end
	...
	elseif command == 'skillchain6' then
      ...
      windower.send_command:schedule(30,'gs c set CastingMode ' .. saved_mode)
		end
