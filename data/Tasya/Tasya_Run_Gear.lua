...
function init_gear_sets()
  ...
  sets.engaged.DTLite = {
    ...
    back=gear.EvasionistsCape.Enm, waist="Windbuffet Belt +1", legs="Meghanada Chausses +2", feet="Meghanada Jambeaux +1"} -- feet="Ahosi Leggings"
