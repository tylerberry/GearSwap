...
function init_gear_sets()
  ...
  --------------------------------------
	...
	sets.Self_Healing = {
		main="Deacon Sword",ammo="Staunch Tathlum",
  ...
  sets.Enmity = {
		main="Mafic Cudgel",ammo="Paeapua",
  ...
  sets.Enmity.SIRD = {
		main="Mafic Cudgel",ammo="Staunch Tathlum",
  ...
  sets.idle = {
		main="Mafic Cudgel",sub="Ochain",ammo="Homiliary",
  ...
  sets.idle.PDT = {
		main="Mafic Cudgel",sub="Ochain",ammo="Staunch Tathlum",
		...
		back="Shadow Mantle",waist="Flume Belt",legs="Arke Cosciales",feet="Souveran Schuhs +1"}
  ...
  sets.defense.MDT_HP = {
		main="Mafic Cudgel",sub="Aegis",ammo="Staunch Tathlum",
    head="Souv. Schaller +1",neck="Loricate Torque +1",ear1="Odnowa Earring +1",ear2="Odnowa Earring",
    body="Rev. Surcoat +3",hands="Souv. Handsch. +1",ring1="Moonbeam Ring",ring2="Moonbeam Ring",
    back="Moonlight Cape",waist="Creed Baudrier",legs="Souv. Diechlings +1",feet="Souveran Schuhs +1"}
  ...
  --------------------------------------
	...
	sets.engaged = {
		main="Mafic Cudgel",sub="Ochain",ammo="Aurgelmir Orb",
  ...
  sets.engaged.Acc = {
		main="Mafic Cudgel",sub="Ochain",ammo="Hasty Pinion +1",
  ...
  sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash"})
	...
	sets.precast.FC.Cure = set_combine(sets.precast.FC, {
		neck="Diemer Gorget", ear1="Nourish. Earring", ear2="Nourish. Earring +1",
		body="Jumalik Mail"})
  ...
  sets.midcast.Flash = set_combine(sets.Enmity, {})
	...
	sets.midcast['Enhancing Magic'] = {
		main="Colada",ammo="Staunch Tathlum",
  ...
  sets.midcast.Shell = set_combine(sets.midcast['Enhancing Magic'], {ring2="Sheltered Ring"})
	...
	sets.midcast.Phalanx = set_combine(sets.midcast['Enhancing Magic'], {
		main="Deacon Sword",hands="Souv. Handsch. +1",back="Weard Mantle",feet="Souveran Schuhs +1"})
