...
function init_gear_sets()
  ...
  sets.defense.MEVA = {
    main="Oranyan",sub="Umbra Strap",ammo="Staunch Tathlum",
  ...
  sets.engaged = {
    ain="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
    head="Befouled Crown",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
  ...
  sets.midcast.Aspir = {main="Rubicundity",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
  ...
  sets.midcast.Aspir.Resistant = {main="Rubicundity",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
