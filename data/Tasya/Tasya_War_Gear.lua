...
function init_gear_sets()
  ...
  sets.Enmity = {}
    ...
    ammo="Staunch Tathlum",
		...
		body="Tartarus Platemail", hands="Sulevia Gauntlets +2", ring1="Defending Ring", ring2=gear.DarkRing.PDT,
		back="Shadow Mantle", waist="Flume Belt +1", legs="Sulevia Cuisses +2", feet="Amm Greaves"}
	...
	sets.defense.PDT = {ammo="Staunch Tathlum",
		head="Genmei Barbuta", neck="Loricate Torque +1", ear1="Genmei Earring", ear2="Ethereal Earring",
		body="Tartarus Platemail", hands="Sulevia Gauntlets +2", ring1="Moonbeam Ring", ring2="Moonbeam Ring",
		back="Shadow Mantle", waist="Flume Belt +1", legs="Sulevia Cuisses +2", feet="Amm Greaves"}
	...
	sets.defense.MDT = {ammo="Staunch Tathlum",
		...
		body="Tartarus Platemail", hands="Sulevia Gauntlets +2", ring1="Moonbeam Ring", ring2="Moonbeam Ring",
		back="Moonlight Cape", waist="Flume Belt +1", legs="Sulevia Cuisses +2", feet="Amm Greaves"}
  ...
  sets.engaged.SomeAcc = {neck="Combatant's Torque", ring1="Flamma Ring"}

  sets.engaged.Acc = {ear1="Dignitary's Earring", ear2="Telos Earring"}

  sets.engaged.FullAcc = {ear1="Zennaroi Earring", ring2="Ramuh Ring +1"}
  ...
  body=gear.valorous_wsd_body, hands="Sulevia Gauntlets +2", ring1="Regal Ring", ring2="Niqmaddu Ring",
  back="Cichol's Mantle", waist="Fotia Belt", legs="Sulevia Cuisses +2", feet="Flamma Gambieras +2"}
