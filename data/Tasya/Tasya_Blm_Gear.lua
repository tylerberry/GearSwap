...
function init_gear_sets()
  ...
  --------------------------------------
	...
	sets.MagicBurst = {
		head="Ea Hat",
		body="Ea Houppelande", hands="Amalric Gages +1", ring1="Mujin Band",
	...
	sets.RecoverBurst = {
		head="Ea Hat", neck="Mizu. Kubikazari",
		body="Spaekona's Coat +3", hands="Amalric Gages +1", ring1="Mujin Band",
		legs="Ea Slops", feet="Jhakri Pigaches +2"}
  ...
  --------------------------------------
	...
	sets.idle.PDT = {
		main="Terra's Staff", sub="Oneiros Grip", ammo="Staunch Tathlum",
	...
	sets.idle.Death = {
		main=gear.grioavolr_nuke_staff, sub="Niobid Strap", ammo="Staunch Tathlum",
  ...
  --------------------------------------
	...
	sets.defense.MEVA = {
		main="Terra's Staff", sub="Enki Strap", ammo="Staunch Tathlum",
  ...
  sets.precast.FC.Curaga = sets.precast.FC.Cure
	...
	sets.precast.FC.Death = {
		main=gear.grioavolr_nuke_staff, sub="Niobid Strap", ammo="Impatiens",
  ...
  sets.midcast.BardSong = {
	  main="Oranyan", sub="Clerisy Strap +1", ammo="Dosis Tathlum",
  ...
  --------------------------------------
	...
	sets.midcast.Stun = {
		main="Oranyan", sub="Enki Strap", ammo="Hasty Pinion +1",
		head="Amalric Coif +1", neck="Voltsurge Torque", ear1="Enchntr. Earring +1", ear2="Loquacious Earring",
  ...
  sets.midcast['Elemental Magic'] = {
		main=gear.Lathi.C, sub="Zuuxowu Grip", ammo="Dosis Tathlum",
  ...
  sets.midcast['Elemental Magic'].OccultAcumen = {
	...
	sets.midcast['Elemental Magic'].HighTierNuke = set_combine(sets.midcast['Elemental Magic'], {
		...
		back=gear.nuke_jse_back, feet=gear.merlinic_nuke_feet})
	...
	sets.midcast['Elemental Magic'].HighTierNuke.Fodder = set_combine(sets.midcast['Elemental Magic'].Fodder, {
		sub="Alber Strap", ammo="Pemphredo Tathlum",
		ear1="Barkaro. Earring", ear2="Regal Earring",
		hands="Amalric Gages +1",
		back=gear.nuke_jse_back, feet=gear.merlinic_nuke_feet})
  ...
  -- FIXME: base off sets.MagicAccuracy
