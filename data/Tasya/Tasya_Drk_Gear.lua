function user_setup()
  ...
  state.MagicalDefenseMode:options('MDT', 'MDTReraise')
	...
	state.Weapons:options('Montante')
  state.ExtraMeleeMode = M{['description']='Extra Melee Mode', 'None'}
	state.Passive = M{['description'] = 'Passive Mode', 'None', 'MP', 'Twilight'}
	state.DrainSwapWeaponMode = M{'Always', 'Never', '300', '1000'}

  gear.NihtMantle = {}
  gear.NihtMantle.Dark = {name="Niht Mantle", augments={'Attack+15','Dark magic skill +8','"Drain" and "Aspir" potency +21','Weapon skill damage +1%'}}
...
function init_gear_sets()
  ...
  --------------------------------------
    ...
    ammo="Pemphredo Tathlum",
		head=gear.CarmineMaskPlus1.D, neck="Erra Pendant", ear1="Gwati Earring", ear2="Dignitary's Earring",
		body="Founder's Breastplate", hands="Leyline Gloves", ring1="Stikini Ring +1", ring2="Stikini Ring +1", -- body="Flamma Korazin +2" --> gear.CarmineScaleMailPlus1.X, hands="Flamma Manopolas +2"
		back="Izdubar Mantle", waist="Eschan Stone", legs="Founder's Hose", feet="Flamma Gambieras +2"} -- legs="Flamma Dirs +2"
  ...
  sets.idle = {
    ...
    head=empty, neck="Bathy Choker +1", ear1="Genmei Earring", ear2="Ethereal Earring",
    body="Lugra Cloak +1", hands="Sulevia's Gauntlets +1", ring1="Defending Ring", ring2=gear.DarkRing.PDT,
  ...
  sets.defense.PDT = {
    ...
    body="Hjarrandi Breastplate", hands="Sulevia's Gauntlets +1", ring1="Defending Ring", ring2="Moonlight Ring",
  ...
  sets.defense.MDT = {
    ammo="Staunch Tathlum +1",
    head="Hjarrandi Helm", neck="Warder's Charm +1", ear1="Genmei Earring", ear2="Ethereal Earring",
    body="Hjarrandi Breastplate", hands="Sulevia's Gauntlets +1", ring1="Defending Ring", ring2="Moonlight Ring",
    back="Moonlight Cape", waist="Flume Belt +1", legs="Sulevia's Cuisses +1", feet="Amm Greaves"}
  ...
  -- EG: sets.engaged.Dagger.Accuracy.Evasion	sets.engaged = {ammo="Aurgelmir Orb",

	sets.engaged = {
    ammo="Aurgelmir Orb",
  	head="Flamma Zucchetto +2", neck="Asperity Necklace", ear1="Brutal Earring", ear2="Cessance Earring",
  	body=gear.valorous_wsd_body, hands=gear.valorous_acc_hands, ring1="Petrov Ring", ring2="Flamma Ring", -- ring2="Niqmaddu Ring",
  	back="Ankou's Mantle", waist="Ioskeha Belt +1", legs="Sulevia's Cuisses +1", feet="Flamma Gambieras +2"}

  sets.engaged.SomeAcc = set_combine(sets.engaged, {neck="Combatant's Torque"})
	sets.engaged.Acc = {ear1="Telos Earring", ear2="Dignitary's Earring"}
  sets.engaged.FullAcc = {ear2="Zennaroi Earring", ring2="Ramuh Ring +1"}
  sets.engaged.Fodder = {}
  ...
  sets.precast.WS = {
    ammo="Knobkierrie",
		head="Flamma Zucchetto +2", neck="Fotia Gorget", ear1="Lugra Earring +1", ear2="Moonshade Earring",
		body="Sulevia's Platemail +1", hands="Sulevia's Gauntlets +1", ring1="Regal Ring", ring2="Shukuyu Ring", -- ring2="Niqmaddu Ring",
		back="Ankou's Mantle", waist="Fotia Belt", legs="Sulevia's Cuisses +1", feet="Flamma Gambieras +2"}
	...
	sets.AccMaxTP = {ear1="Telos Earring", ear2="Zennaroi Earring"}
	sets.AccDayMaxTPWSEars = {ear1="Telos Earring", ear2="Zennaroi Earring"}
	sets.DayMaxTPWSEars = {ear1="Brutal Earring", ear2="Ishvara Earring"}
	sets.AccDayWSEars = {ear1="Telos Earring", ear2="Zennaroi Earring"}
	sets.DayWSEars = {ear1="Brutal Earring", ear2="Moonshade Earring"}

  --------------------------------------
  -- Precast: Great Sword Weaponskills
  --------------------------------------
  ...
  --------------------------------------
	...
	sets.precast.FC = {ammo="Impatiens",
		...
		body=gear.OdysseanChestplate.FC, hands="Leyline Gloves", ring1="Prolix Ring", ring2="Kishar Ring",
  ...
  --------------------------------------
    ...
    -- body=gear.CarmineScaleMailPlus1.X
    back=gear.NihtMantle.Dark, legs=gear.EschiteCuisses.D})

	sets.midcast.Absorb = set_combine(sets.midcast['Dark Magic'], {ring2="Kishar Ring", back="Chuparrosa Mantle"})

  sets.midcast.Aspir = set_combine(sets.midcast['Dark Magic'], {
    head="Pixie Hairpin +1", neck="Erra Pendant", ear1="Hirudinea Earring",
    ring1="Evanescence Ring", ring2="Archon Ring",
    back="Niht Mantle"})

  sets.midcast.Drain = sets.midcast.Aspir
  sets.DrainWeapon = {} -- {main="Misanthropy", sub="Kaja Grip"}
  ...
  sets.midcast['Dread Spikes'] = set_combine(sets.midcast['Dark Magic'], {})
    ...
    ammo="Pemphredo Tathlum",
		head=gear.CarmineMaskPlus1.D, neck="Erra Pendant", ear1="Gwati Earring", ear2="Dignitary's Earring",
		body="Founder's Breastplate", hands="Leyline Gloves", ring1="Stikini Ring +1", ring2="Stikini Ring +1",
		back="Izdubar Mantle", waist="Eschan Stone", legs=gear.EschiteCuisses.D, feet="Flamma Gambieras +2"}

  --------------------------------------
  -- Midcast: Enfeebling Magic
  --------------------------------------

  sets.midcast['Elemental Magic'] = set_combine(sets.MagicAccuracy, {})
  ...
  --------------------------------------
    ...
    head=gear.CarmineMaskPlus1.D, ring2="Kishar Ring"})
