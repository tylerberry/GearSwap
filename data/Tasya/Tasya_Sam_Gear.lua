...
function init_gear_sets()
  ...
  sets.idle = {
    ...
    body="Hizamaru Haramaki +2", hands="Sakonji Kote +1", ring1="Defending Ring", ring2=gear.DarkRing.PDT,
  ...
  sets.engaged = {
    ...
    body="Kasuga Domaru +1", hands=gear.valorous_acc_hands, ring1="Flamma Ring", ring2="Petrov Ring", -- ring2="Niqmaddu Ring"
    back="BLeating Mantle", waist="Ioskeha Belt +1", legs=gear.ValorousHose.DA, feet="Flamma Gambieras +2"}
  ...
  sets.engaged.Adoulin.SomeAcc = {ammo="Aurgelmir Orb",
      ...
      body="Kasuga Domaru +1", hands="Flamma Manopolas +1", ring1="Niqmaddu Ring", ring2="Ilabrat Ring",
  ...
  sets.engaged.Adoulin.FullAcc = {ammo="Aurgelmir Orb",
      head="Flamma Zucchetto +2", neck="Combatant's Torque", ear1="Zennaroi Earring", ear2="Telos Earring",
      body="Kasuga Domaru +1", hands="Flamma Manopolas +1", ring1="Ramuh Ring +1", ring2="Ramuh Ring +1",
  ...
  sets.precast.WS.Fodder = set_combine(sets.precast.WS, {})
    ...
    body="Tartarus Platemail", hands="Flamma Manopolas +1", ring1="Ramuh Ring +1", ring2="Ramuh Ring +1",
    back=gear.stp_jse_back, waist="Olseni Belt", legs="Wakido Haidate +3", feet="Flamma Gambieras +2"}
  ...
  sets.precast.WS['Tachi: Ageha'] = {ammo="Pemphredo Tathlum",
    ...
    body="Flamma Korazin +1", hands="Flamma Manopolas +1", ring1="Ramuh Ring +1", ring2="Ramuh Ring +1",
  ...
  sets.precast.Waltz = {
    ...
    body="Tartarus Platemail", hands="Flamma Manopolas +1", ring1="Asklepian Ring", ring2="Valseur's Ring",
