...
function init_gear_sets()
  ...
  sets.idle = {
    ...
    body="Hizamaru Haramaki +1", hands="Sakonji Kote +1", ring1="Defending Ring", ring2=gear.DarkRing.PDT,
    back="Moonlight Cape", waist="Flume Belt +1", legs="Flamma Dirs +1", feet="Danzo Sune-ate"}
  ...
  sets.idle.Weak = {
    ...
    body="Twilight Mail", hands="Sakonji Kote +1", ring1="Defending Ring", ring2=gear.DarkRing.PDT,
    back="Moonlight Cape", waist="Flume Belt +1", legs="Flamma Dirs +1", feet="Danzo Sune-ate"}
  ...
  sets.defense.PDT = {
    ...
    back="Moonlight Cape", waist="Ioskeha Belt +1", legs="Wakido Haidate +3", feet="Amm Greaves"}
  ...
  sets.resting = {
    ...
    body="Hizamaru Haramaki +1", hands="Sakonji Kote +1", ring1="Defending Ring", ring2=gear.DarkRing.PDT,
    back="Moonlight Cape", waist="Flume Belt +1", legs="Wakido Haidate +3", feet="Flamma Gambieras +2"}
  ...
  sets.weapons.Masamune = {main="Shirodachi", sub="Utu Grip"}
  ...
  sets.engaged = {
    ammo="Aurgelmir Orb",
    head="Flamma Zucchetto +2", neck="Anu Torque", ear1="Cessance Earring", ear2="Brutal Earring",
    body="Flamma Korazin +2", hands="Flamma Manopolas +2", ring1="Flamma Ring", ring2="Petrov Ring", -- ring2="Niqmaddu Ring"
    back="Bleating Mantle", waist="Ioskeha Belt +1", legs="Flamma Dirs +1", feet="Flamma Gambieras +2"}

  sets.engaged.SomeAcc = {
    ammo="Aurgelmir Orb",
    head="Flamma Zucchetto +2", neck="Moonbeam Nodowa", ear1="Cessance Earring", ear2="Telos Earring",
    body="Kendatsuba Samue", hands="Wakido Kote +3", ring1="Niqmaddu Ring", ring2="Flamma Ring",
    back=gear.stp_jse_back, waist="Ioskeha Belt +1", legs="Wakido Haidate +3", feet="Flamma Gambieras +2"}

  sets.engaged.Acc = {
    ammo="Aurgelmir Orb",
    head="Wakido Kabuto +3", neck="Moonbeam Nodowa", ear1="Dignitary's Earring", ear2="Telos Earring",
    body="Kendatsuba Samue", hands="Wakido Kote +3", ring1="Niqmaddu Ring", ring2="Regal Ring",
    back=gear.stp_jse_back, waist="Ioskeha Belt +1", legs="Wakido Haidate +3", feet="Flamma Gambieras +2"}

  sets.engaged.FullAcc = {
    ammo="Aurgelmir Orb",
    head="Wakido Kabuto +3", neck="Moonbeam Nodowa", ear1="Zennaroi Earring", ear2="Telos Earring",
    body="Kendatsuba Samue", hands="Wakido Kote +3", ring1="Ramuh Ring +1", ring2="Regal Ring",
  ...
  sets.engaged.PDT = {
    ammo="Staunch Tathlum +1",
    head="Loess Barbuta +1", neck="Loricate Torque +1", ear1="Etiolation Earring", ear2="Sanare Earring",
    body="Tartarus Platemail", hands="Wakido Kote +3", ring1="Defending Ring", ring2=gear.DarkRing.PDT,
    back="Moonlight Cape", waist="Ioskeha Belt +1", legs="Wakido Haidate +3", feet="Amm Greaves"}
  ...
  sets.engaged.DTLite = {
    ...
    body="Tartarus Platemail", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Patricius Ring",
    back=gear.stp_jse_back, waist="Ioskeha Belt +1", legs="Wakido Haidate +3", feet="Amm Greaves"}
  ...
  sets.engaged.Adoulin = {ammo="Aurgelmir Orb",
      ...
      back=gear.stp_jse_back, waist="Ioskeha Belt +1", legs="Wakido Haidate +3", feet="Flamma Gambieras +2"}
  sets.engaged.Adoulin.SomeAcc = {ammo="Aurgelmir Orb",
      head="Flamma Zucchetto +2", neck="Combatant's Torque", ear1="Cessance Earring", ear2="Brutal Earring",
      body="Kasuga Domaru +1", hands="Flamma Manopolas +2", ring1="Niqmaddu Ring", ring2="Ilabrat Ring",
  ...
  sets.engaged.Adoulin.Acc = {ammo="Aurgelmir Orb",
      head="Flamma Zucchetto +2", neck="Combatant's Torque", ear1="Zennaroi Earring", ear2="Telos Earring",
      body="Kasuga Domaru +1", hands="Flamma Manopolas +2", ring1="Niqmaddu Ring", ring2="Ilabrat Ring",
      back=gear.stp_jse_back, waist="Olseni Belt", legs="Wakido Haidate +3", feet="Amm Greaves"}
  sets.engaged.Adoulin.FullAcc = {ammo="Aurgelmir Orb",
      head="Flamma Zucchetto +2", neck="Combatant's Torque", ear1="Zennaroi Earring", ear2="Telos Earring",
      body="Kasuga Domaru +1", hands="Flamma Manopolas +2", ring1="Ramuh Ring +1", ring2="Ramuh Ring +1",
      back=gear.stp_jse_back, waist="Olseni Belt", legs="Wakido Haidate +3", feet="Flamma Gambieras +2"}
  sets.engaged.Adoulin.Fodder = {ammo="Aurgelmir Orb",
      head="Flamma Zucchetto +2", neck="Asperity Necklace", ear1="Cessance Earring", ear2="Brutal Earring",
      body="Kasuga Domaru +1", hands="Flamma Manopolas +2", ring1="Niqmaddu Ring", ring2="Ilabrat Ring",
      back=gear.stp_jse_back, waist="Windbuffet Belt +1", legs="Wakido Haidate +3", feet="Flamma Gambieras +2"}
  sets.engaged.Adoulin.PDT = {ammo="Staunch Tathlum +1",
      head="Flamma Zucchetto +2", neck="Loricate Torque +1", ear1="Cessance Earring", ear2="Brutal Earring",
      body="Tartarus Platemail", hands=gear.valorous_wsd_hands, ring1="Defending Ring", ring2=gear.DarkRing.PDT,
  ...
  sets.engaged.Adoulin.FullAcc.PDT = {ammo="Staunch Tathlum +1",
      head="Flamma Zucchetto +2", neck="Loricate Torque +1", ear1="Zennaroi Earring", ear2="Telos Earring",
      body="Tartarus Platemail", hands=gear.valorous_wsd_hands, ring1="Defending Ring", ring2="Patricius Ring",
  ...
  sets.precast.WS.Fodder = set_combine(sets.precast.WS, {})
    ...
    ammo="Hasty Pinion +1",
    head="Flamma Zucchetto +2", neck="Moonbeam Nodowa", ear1="Zennaroi Earring", ear2="Telos Earring",
    body="Tartarus Platemail", hands="Flamma Manopolas +2", ring1="Ramuh Ring +1", ring2="Ramuh Ring +1",
    back=gear.stp_jse_back, waist="Olseni Belt", legs="Wakido Haidate +3", feet="Flamma Gambieras +2"}

  --------------------------------------
  -- Precast: Great Katana Weaponskills
  --------------------------------------
  ...
  sets.precast.WS['Tachi: Ageha'] = {ammo="Pemphredo Tathlum",
    head="Flamma Zucchetto +2", neck="Sanctity Necklace", ear1="Dignitary's Earring", ear2="Moonshade Earring",
    body="Flamma Korazin +1", hands="Flamma Manopolas +2", ring1="Ramuh Ring +1", ring2="Ramuh Ring +1",
    back=gear.ws_jse_back, waist="Eschan Stone", legs="Flamma Dirs +1", feet="Flamma Gambieras +2"}
  ...
  sets.precast.WS['Tachi: Jinpu'] = set_combine(sets.precast.WS, {
    head=gear.valorous_magical_wsd_head, ear1="Friomisi Earring", body="Founder's Breastplate", hands="Founder's Gauntlets", feet="Founder's Greaves"})
  ...
  sets.precast.Waltz = {
    ...
    body="Tartarus Platemail", hands="Flamma Manopolas +2", ring1="Asklepian Ring", ring2="Valseur's Ring",
  ...
  if player.sub_job == "NIN" then
    sets.midcast['Ninjutsu'] = set_combine(sets.midcast.FastRecast, {back="Mujin Mantle"})
  end
