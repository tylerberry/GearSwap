...
function init_gear_sets()
  ...
  sets.defense.HP = {
    ...
    head="Genmei Kabuto", neck="Loricate Torque +1", ear1="Etiolation Earring", ear2="Sanare Earring",
    body="Emet Harness +1", hands=gear.herculean_dt_hands, ring1="Defending Ring", ring2="Dark Ring",
    back="Segomo's Mantle", waist="Black Belt", legs=gear.herculean_dt_legs, feet="Hippomenes Socks +1"}
  ...
  sets.defense.MDT = {
    ...
    back="Moonlight Cape", waist="Flax Sash", legs=gear.herculean_dt_legs, feet="Hippomenes Socks +1"}
  ...
  sets.engaged.Acc = {
    ...
    hands="Ryuo Tekko", ring2="Ramuh Ring +1",
    waist="Olseni Belt", legs="Mummu Kecks +2", feet=gear.herculean_acc_feet}
  sets.engaged.FullAcc = {
    head="Mummu Bonnet +2", ear1="Zennaroi Earring", ear2="Telos Earring",
    body="Mummu Jacket +2", ring1="Ramuh Ring +1",
    legs="Hiza. Hizayoroi +2"}
  sets.engaged.Fodder = {body="Adhemar Jacket +1", feet="Sokushitsu Sune-Ate"}
  ...
  sets.engaged.SomeAcc.PDT = {
    ammo="Falcon Eye",
    head="Dampening Tam", neck="Moonbeam Nodowa"}
  sets.engaged.Acc.PDT = {
    ear1="Cessance Earring",
    ring2="Patricius Ring",
    back="Segomo's Mantle", waist="Olseni Belt"}
  sets.engaged.FullAcc.PDT = {
    ear1="Zennaroi Earring", ear2="Telos Earring",
    body="Bhikku Cyclas +1", hands="Hesychast's Gloves +1"}
  ...
  sets.engaged.SomeAcc.PDTOnly = {
    head="Dampening Tam", ear1="Cessance Earring",
    hands="Hes. Gloves +1"}
  sets.engaged.Acc.PDTOnly = {
    ammo="Falcon Eye",
    legs="Samnuha Tights", feet=gear.herculean_acc_feet}
  ...
  --------------------------------------
  -- Precast: Hand-to-Hand Weaponskills
  --------------------------------------
