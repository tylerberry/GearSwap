...
function init_gear_sets()
  ...
  sets.MagicAttack = set_combine(sets.MagicAttackNW, {
	...
	sets.defense.MDT = {
      main="Terra's Staff", sub="Oneiros Grip", range=gear.Linos.DT, ammo=empty,
	  head="Inyanga Tiara +1", neck="Loricate Torque +1", ear1="Ethereal Earring", ear2="Etiolation Earring",
	  body="Inyanga Jubbah +2", hands="Inyanga Dastanas +1", ring1="Defending Ring", ring2=gear.DarkRing.PDT,
	  back="Moonlight Cape", waist="Flume Belt +1", legs="Assiduity Pants +1", feet="Inyanga Crackows +1"}
	...
	sets.defense.MEVA = {
	  ...
	  head="Inyanga Tiara +1", neck="Loricate Torque +1", ear1="Ethereal Earring", ear2="Etiolation Earring",
	  body="Inyanga Jubbah +2", hands="Inyanga Dastanas +1", ring1="Defending Ring", ring2=gear.DarkRing.PDT,
	  back="Moonlight Cape", waist="Flume Belt +1", legs="Inyanga Shalwar +2", feet="Inyanga Crackows +1"}
  ...
  -- These Telchine Pigaches have -7% song casting time augment.
    ...
    main=gear.Kali.A, sub="Genmei Shield", range="Gjallarhorn", ammo=empty,
		...
		body="Inyanga Jubbah +2", hands="Gendewitha Gages +1", ring1="Lebeche Ring", ring2="Kishar Ring",
  ...
  if player.sub_job == "PLD" or player.sub_job == "RDM" or player.sub_job == "SCH" or player.sub_job == "WHM" then
  	sets.midcast.Cure = {
      head=gear.KaykausMitraPlus1.B, neck="Incanter's Torque", ear1="Novia Earring", ear2="Halasz Earring",
      body=gear.KaykausBliautPlus1.D, hands=gear.KaykausCuffsPlus1.A, ring1="Kuchekula Ring", ring2="Menelaus's Ring",
      back="Thaumaturge's Cape", waist="Ninurta's Sash", legs="Gyve Trousers", feet=gear.KaykausBootsPlus1.B}
  end
