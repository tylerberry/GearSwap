...
function init_gear_sets()
  ...
  sets.Healing = {
    ...
    body="Vrikodara Jupon", hands="Leyline Gloves", ring1="Prolix Ring", ring2="Sirona's Ring",
  ...
  sets.MagicAttackWeapons = set_combine(sets.MagicAttack, {main="Naegling", sub=gear.NibiruCudgel.B})
	...
	sets.PlusEnmity = {
		ammo="Sapience Orb",
		neck="Unmoving Collar +1", ear1="Friomisi Earring", ear2="Cryptic Earring", --head="Rabid Visor",
  ...
  sets.idle = {
    ...
    body="Jhakri Robe +2", hands=gear.HerculeanGloves.Refresh, ring1="Stikini Ring +1", ring2="Stikini Ring +1", -- body="Jhakri Robe +2",
  ...
  sets.engaged = {
    main="Naegling", sub=gear.Colada.DA, ammo="Ginsen",
	...
	sets.engaged.Acc = set_combine(sets.engaged.SomeAcc, {legs=gear.CarmineCuissesPlus1.D}) -- body="Ayanmo Corazza +2"
  ...
  sets.engaged.DTLite = set_combine(sets.engaged, {
    ...
    waist="Shetal Stone"}) -- waist="Reiki Yotai", legs="Ayanmo Cosciales +2", feet="Ahosi Leggings"
  ...
  sets.precast.WS = {
    ...
    back="Bleating Mantle", waist="Prosilio Belt +1", legs=gear.TaeonTights.TA, feet=gear.HerculeanBoots.WSD}
  ...
  if player.sub_job == "DNC" then
    ...
    sets.precast.Waltz = {
      ...
      body="Passion Jacket", hands=gear.HerculeanGloves.Waltz, ring1="Defending Ring", ring2="Sirona's Ring",
  ...
  --------------------------------------
    ...
    main="Tanmogayi +1", sub="Vampirism", ammo="Hasty Pinion +1",
		...
		body=gear.TaeonTabard.PhalanxFC, hands="Leyline Gloves", ring2="Prolix Ring",
  ...
  sets.midcast['Blue Magic'].Physical = {
    ...
    head=gear.AdhemarBonnetPlus1.B, neck="Caro Necklace", ear1="Vulcan's Pearl", ear2="Vulcan's Pearl", -- ear1="Tati Earring +1", ear2="Tati Earring +1"
    body=gear.AdhemarJacketPlus1.B, hands=gear.AdhemarWristbandsPlus1.B, ing1="Ifrit Ring +1", ring2="Ifrit Ring +1",
    back="Cornflower Cape", waist="Prosilio Belt +1", legs="Jhakri Slops +1", feet="Jhakri Pigaches +1"}
