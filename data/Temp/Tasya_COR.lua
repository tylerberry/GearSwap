...
function user_setup()
    ...
    gear.MagicWSBullet = "Bronze Bullet"
    gear.QuickDrawBullet = "Adlivun Bullet"
...
function init_gear_sets()
    ...
    tas_shared_augmented_gear()-- Sets to return to when not performing an action.
    ...
    sets.idle.Town = {
        main="Surcouf's Jambiya",range="Eminent Gun",ammo=gear.RABullet,
    ...
    sets.defense.MDT = {
        ...
        back="Engulfer Cape +1",waist="Flume Belt +1",legs="Nahtirah Trousers",feet="Iuitl Gaiters +1"}
    ...
    sets.precast.CorsairRoll = {head="Lanun Tricorne",hands="Navarch's Gants +2",back="Camulus's Mantle"}
    ...
    sets.precast.WS['Last Stand'] = sets.precast.WS.Gun
    ...
    sets.precast.WS['Wildfire'] = sets.precast.WS.GunMagic
    ...
    sets.precast.WS['Leaden Salute'] = sets.precast.WS.GunMagic
    ...
    sets.precast.RA = {
        ...
        back="Navarch's Mantle",waist="Impulse Belt",legs=gear.AdhemarKecks.C,feet="Meghanada Jambeaux +1"}
    ...
    sets.midcast.RA = {
        ...
        body="Laksamana's Frac",hands="Iuitl Wristbands",ring1="Rajas Ring",ring2="Stormsoul Ring",
        back="Terebellum Mantle",waist="Commodore Belt",legs=gear.AdhemarKecks.C,feet="Meghanada Jambeaux +1"}
    ...
    sets.midcast.RA.Acc = {
        ...
        back="Libeccio Mantle",waist="Commodore Belt",legs=gear.AdhemarKecks.C,feet="Meghanada Jambeaux +1"}
