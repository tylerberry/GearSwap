...
function user_setup()
  ...
  if player.sub_job == "WAR" then
	state.Weapons:options('SariJugo', 'SariOdium', 'MagicWeapons', 'ProcDagger', 'ProcSword', 'ProcScythe', 'ProcClub', 'ProcStaff', 'ProcPolearm')
  else
	state.Weapons:options('SariJugo', 'SariOdium', 'SariFusetto', 'MagicWeapons')
  end
...
function init_gear_sets()
  ...
  sets.weapons.SariJugo = {main=gear.TamingSari.High, sub="Jugo Kukri +1"}
	sets.weapons.SariOdium = {main=gear.TamingSari.High, sub="Odium"}
	sets.weapons.SariFusetto = {main=gear.TamingSari.High, sub="Fusetto"}
	--sets.weapons.LowBuff = {main="Aeneas", sub="Blurred Knife +1"}
	sets.weapons.MagicWeapons = {main=gear.Malevolence.Max, sub=gear.Malevolence.High}
  ...
  sets.precast.WS.DEX.SA = set_combine(sets.precast.WS.DEX, {
    ammo="Yetshila +1", head=gear.AdhemarBonnetPlus1.B, body="Meghanada Cuirie +2"}) -- ammo="Yetshila +1"
  ...
  sets.precast.WS.DEXCrit = {
    ammo="Yetshila +1", -- ammo="Yetshila +1"
    head=gear.AdhemarBonnetPlus1.B, neck="Caro Necklace", ear1="Sherida Earring", ear2="Mache Earring +1",
  ...
  sets.precast.WS.Magic = {
    ...
    body="Samnuha Coat", hands="Leyline Gloves", ring1="Shiva Ring +1", ring2="Shiva Ring +1", -- ring1=
  ...
  --[[
  sets.midcast.RA = {
    head="Mummu Bonnet +2", neck="Combatant's Torque", ear1="Enervating Earring", ear2="Neritic Earring",
