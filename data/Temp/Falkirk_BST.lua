...
magic_atk_ready_moves = S{'Dust Cloud','Cursed Sphere','Venom','Toxic Spit','Bubble Shower','Drainkiss',
    ...
    'Acid Spray','Infected Leech','Gloom Spray'}
...
magic_acc_ready_moves = S{'Sheep Song','Scream','Dream Flower','Roar','Gloeosuccus','Palsy Pollen',
    ...
    'Choke Breath','Jettatura','Molting Plumage','Spider Web'}
...
function init_gear_sets()
    ...
    Ready_Acc_TPBonus_Axe = {name="Kumbhakarna", augments={'Pet: Accuracy+20 Pet: Rng. Acc.+20','Pet: "Dbl.Atk."+2 Pet: Crit.hit rate +2','Pet: TP Bonus+200',}}
    ...
    Ready_MAB_TPBonus_Axe2 = {name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+20','Pet: Phys. dmg. taken -4%','Pet: TP Bonus+200',}}
    ...
    Pet_PDT_back = {name="Artio's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Eva.+20 /Mag. Eva.+20','Pet: Attack+10 Pet: Rng.Atk.+10','Pet: Haste+10','System: 1 ID: 1246 Val: 4',}}
    ...
    Pet_MDT_back = "Pastoralist's Mantle"
    ...
    MAcc_head = "Tali'ah Turban +2"
    MAcc_body = "Tali'ah Manteel +2"
    MAcc_hands = "Tali'ah Gages +2"
    MAcc_legs = "Tali'ah Seraweels +2"
    MAcc_feet = "Tali'ah Crackows +2"
    MAcc_back = {name="Artio's Mantle", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','Enmity+10',}}

    DT_Legs = {name="Valor. Hose", augments={'Weapon Skill Acc.+13','"Fast Cast"+3','Damage taken-5%','Accuracy+1 Attack+1',}}
    ...
    MEva_head = "Heyoka Cap"
    MEva_body = "Heyoka Harness"
    MEva_hands = "Heyoka Mittens"
    MEva_legs = "Heyoka Subligar +1"
    MEva_feet = "Heyoka Leggings"
    ...
    TH_legs = {name="Valor. Hose", augments={'STR+3','INT+5','"Treasure Hunter"+2','Mag. Acc.+18 "Mag.Atk.Bns."+18',}}
    ...
    sets.precast.JA.Reward = {ammo="Pet Food Theta",
        ...
        back=Reward_back,waist="Engraved Belt",legs="Totemic Trousers +3",feet="Ankusa Gaiters +3"}
    ...
    sets.precast.JA.Charm = {ammo="Tsar's Egg",
        ...
        body="Totemic Jackcoat +3",hands="Ankusa Gloves +3",ring1="Dawnsoul Ring",ring2="Dawnsoul Ring",
    ...
    sets.idle = {ammo="Staunch Tathlum",
        ...
        back="Solemnity Cape",waist="Lycopodium Sash",legs="Meghanada Chausses +2",feet="Skadi's Jambeaux +1"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        ...
        body="Tartarus Platemail",hands="Meghanada Gloves +2",ring1="Meghanada Ring",ring2="Warden's Ring",
        back="Shadow Mantle",waist="Flume Belt +1",legs=DT_Legs,feet="Amm Greaves"}
    ...
    sets.defense.HybridPDT = {ammo="Sihirik",
        ...
        body="Tartarus Platemail",hands=Pet_PDT_hands,ring1="Dark Ring",ring2="Defending Ring",
    ...
    sets.defense.MDT = set_combine(sets.defense.PDT, {ammo="Sihirik",
        ...
        body="Tartarus Platemail",hands="Leyline Gloves",
    ...
    sets.engaged = {ammo="Ginsen",
        ...
        body="Tali'ah Manteel +2",hands="Argosy Mufflers +1",ring1="Hetairoi Ring",ring2="Epona's Ring",
        back=STR_DA_back,waist="Windbuffet Belt +1",legs="Meghanada Chausses +2",feet="Argosy Sollerets +1"}
    ...
    sets.engaged.DW.Hybrid = {ammo="Demonry Core",
        head=Pet_PDT_head,neck="Shulmanu Collar",ear1="Enmerkar Earring",ear2="Telos Earring",
    ...
    sets.engaged.DW.KrakenClub = {ammo="Ginsen",
        head="Totemic Helm +3",neck="Shulmanu Collar",ear1="Suppanomimi",ear2="Eabani Earring",
        body="Totemic Jackcoat +3",hands="Totemic Gloves +3",ring1="Ilabrat Ring",ring2="Defending Ring",
    ...
    sets.precast.WS = {ammo="Floestone",
        head="Argosy Celata +1",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Telos Earring",
        body="Argosy Hauberk +1",hands="Argosy Mufflers +1",ring1="Ifrit Ring +1",ring2="Epona's Ring",
        back=STR_WS_back,waist="Windbuffet Belt +1",legs="Argosy Breeches +1",feet="Argosy Sollerets +1"}

    sets.precast.WS['Rampage'] = {ammo="Floestone",
        head="Heyoka Cap",neck="Fotia Gorget",ear1="Sherida Earring",ear2="Telos Earring",
        body="Heyoka Harness",hands="Heyoka Mittens",ring1="Ifrit Ring +1",ring2="Epona's Ring",
        back=STR_DA_back,waist="Fotia Belt",legs="Heyoka Subligar +1",feet="Heyoka Leggings"}
    ...
    sets.precast.WS['Calamity'] = {ammo="Floestone",
        head="Argosy Celata +1",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Telos Earring",
        body="Argosy Hauberk +1",hands="Meghanada Gloves +2",ring1="Ifrit Ring +1",ring2="Epona's Ring",
        back=STR_WS_back,waist="Windbuffet Belt +1",legs="Argosy Breeches +1",feet="Argosy Sollerets +1"}

    sets.precast.WS['Mistral Axe'] = {ammo="Floestone",
        head="Ankusa Helm +3",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Telos Earring",
        body="Argosy Hauberk +1",hands="Meghanada Gloves +2",ring1="Ifrit Ring +1",ring2="Epona's Ring",
        back=STR_WS_back,waist="Windbuffet Belt +1",legs="Argosy Breeches +1",feet="Argosy Sollerets +1"}

    sets.precast.WS['Bora Axe'] = {ammo="Cheruski Needle",
        head="Ankusa Helm +3",neck="Caro Necklace",ear1="Sherida Earring",ear2="Telos Earring",
        body="Argosy Hauberk +1",hands="Meghanada Gloves +2",ring1="Ilabrat Ring",ring2="Epona's Ring",
        back=Onslaught_back,waist="Windbuffet Belt +1",legs="Argosy Breeches +1",feet="Argosy Sollerets +1"}

    sets.precast.WS['Ruinator'] = {ammo="Floestone",
        head="Argosy Celata +1",neck="Fotia Gorget",ear1="Sherida Earring",ear2="Telos Earring",
        body="Argosy Hauberk +1",hands="Argosy Mufflers +1",ring1="Ifrit Ring +1",ring2="Epona's Ring",
        back=STR_DA_back,waist="Fotia Belt",legs="Meghanada Chausses +2",feet="Argosy Sollerets +1"}
